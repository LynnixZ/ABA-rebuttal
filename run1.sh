...
#     --blank_space_in_equation_number=501 --digit_test_number=500 \
...
#     --out_dir='out/addition_50_ABA_505/run3' \
#     --wandb_run_name=run3 --seed=1337 --device=cuda:1 --block_size=2024 \
#     --time_limit=60000 --test_batch_size 64

# python eval.py  \
#   --out_dir out/addition_50_ABA_505/run3/run3 \
#   --ckpt out/addition_50_ABA_505/run3/addition_10_best_ood.pt \
...
#   --mode length_10 --operator + --digit_test_number 500 --plot
  ...
  python train.py config/addition_10digits.py \
    ...
    --blank_space_exact=True  --eval_interval=1000 \
    --out_dir='out/addition_20_ABA_202/run3' \
    --train_data_path=+_maxLen_20_limit_1000000_train_minReq_0.txt \
    --wandb_run_name=run --seed=1327 --device=cuda:1 --block_size=2024 --time_limit=40000

  python train.py config/addition_10digits.py \
    --positional_embedding=RPEBias --max_iters=30000 \
    --blank_space_in_equation_number=202 --digit_test_number=200 \
    --blank_space_exact=True  --eval_interval=1000 \
    --out_dir='out/addition_20_ABA_202/run4' \
    --train_data_path=+_maxLen_20_limit_1000000_train_minReq_0.txt \
    --wandb_run_name=run --seed=1237 --device=cuda:1 --block_size=2024 --time_limit=40000
