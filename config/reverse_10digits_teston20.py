...
block_size = 256
train_data_path = 'reverse_train_10.txt'
start = 'FILE:data/bal/newtask/reverse_test_20.txt'
start_train="FILE:data/bal/newtask/reverse_test_10.txt" #不知道为什么无法在command line改
