...
operator_digit_test="string_reverse"
...
block_size = 256
train_data_path = 'string_reverse_train.txt'
start = 'FILE:data/newtask/string_reverse_test_50.txt'
start_train="FILE:data/newtask/string_reverse_test_10.txt" #不知道为什么无法在command line改
ckpt_path_name = f'monet_6layer1mixing1poly_5000iter.pt'#不知道为什么无法在command line改
reverse_c = True
eval_addition = True
...
max_number_length = 0
noorder = False
blank_space_in_equation_number = 51  # Placeholder; ensure `blank_space` is defined
