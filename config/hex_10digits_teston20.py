...
block_size = 256
train_data_path = 'hexadecimal_train_10.txt'
start = 'FILE:data/newtask/train/hexadecimal_test_20.txt'
start_train="FILE:data/newtask/train/hexadecimal_test_10.txt" #不知道为什么无法在command line改
