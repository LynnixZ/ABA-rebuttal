...
operator_digit_test="char_shift"
...
block_size = 256
train_data_path = 'char_shift_train.txt'
start = 'FILE:data/newtask/char_shift_test_50.txt'
start_train="FILE:data/newtask/char_shift_test_10.txt" #不知道为什么无法在command line改
